    <div class="container pt-100 pb-30">
      <div class="row mb-50">
        <div class="col-sm-4 col-md-4 mb-sm-60">
          <div class="contact-icon-box p-30">
            ...
            <h4 class="text-uppercase text-white">Addresse</h4>
        ...
        <div class="col-sm-4 col-md-4 mb-sm-60">
          <div class="contact-icon-box p-30">
            ...
            <p class="font-16">Lorem ipsum dolor sit amet<br>
              <a class="" href="mailto:mail@kodesolution.com" target="_top">email : mail@gmail.com </a> </p>
          </div>
        </div>
        <div class="col-sm-4 col-md-4">
          <div class="contact-icon-box p-30">
            <div class="contact-icon bg-theme-colored"> <i class="fa fa-phone text-white font-22"></i> </div>
            <h4 class="text-uppercase text-white">Téléphone</h4>
            <p class="font-16">Lorem ipsum dolor sit amet<br>
                +1 123 456 789</p>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark"> <img class="mt-10 mb-20" alt="" src="test/logo_bioactivfit_q°.jpg">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="opening-hours list-border">
              <li><p><span class="text-white">Lundi au Vendredi:</span> <br>
                9:00 / 21:00</p>
              </li>
            </ul>
          </div>
