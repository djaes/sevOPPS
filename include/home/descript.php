                    ...
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <h2 class="text-uppercase title"><span class="text-black font-weight-300">Les plus de Bioactivfit</span></h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card effect__hover">
                                    <div class="card__front bg-theme-colored">
                                        <div class="card__text">
                                            <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="images/nopal.jpg" alt="">
                            ...
                            <div class="col-sm-4">
                                <div class="card effect__hover">
                                    <div class="card__front bg-theme-colored">
                                        <div class="card__text">
                                            <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="images/thea_sinensis.jpg" alt="">
                            ...
                            <div class="col-sm-4">
                                <div class="card effect__hover">
                                    <div class="card__front bg-theme-colored">
                                        <div class="card__text">
                                            <div class="icon-box mb-0 mt-0 p-0"> <img class="img-responsive img-fullwidth" src="images/cetone-framboise.jpg" alt="">
