<form name="cmdForm" class="register-form form-transparent" method="post"  style="margin: 20px;">
    ...
    <div class="form-group">
        <button class="btn btn-dark btn-lg btn-block mt-12" type="submit">Commande</button>
        <button class="btn btn-dark btn-lg btn-block mt-12" type="submit">Annuler</button>
    </div>
</form>